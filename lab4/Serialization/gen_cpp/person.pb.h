...
class Person_SomeNumber;
struct Person_SomeNumberDefaultTypeInternal;
extern Person_SomeNumberDefaultTypeInternal _Person_SomeNumber_default_instance_;
extern const ::google::protobuf::internal::ClassDataFull Person_SomeNumber_class_data_;
}  // namespace tutorial
namespace google {
namespace protobuf {
template <>
...
class Person_SomeNumber final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:tutorial.Person.SomeNumber) */ {
 public:
  inline Person_SomeNumber() : Person_SomeNumber(nullptr) {}
  ~Person_SomeNumber() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Person_SomeNumber* PROTOBUF_NONNULL msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(Person_SomeNumber));
  }
#endif

  template <typename = void>
  explicit PROTOBUF_CONSTEXPR Person_SomeNumber(::google::protobuf::internal::ConstantInitialized);

  inline Person_SomeNumber(const Person_SomeNumber& from) : Person_SomeNumber(nullptr, from) {}
  inline Person_SomeNumber(Person_SomeNumber&& from) noexcept
      : Person_SomeNumber(nullptr, std::move(from)) {}
  inline Person_SomeNumber& operator=(const Person_SomeNumber& from) {
    CopyFrom(from);
    return *this;
  }
  inline Person_SomeNumber& operator=(Person_SomeNumber&& from) noexcept {
  ...
  static const Person_SomeNumber& default_instance() {
    return *reinterpret_cast<const Person_SomeNumber*>(
        &_Person_SomeNumber_default_instance_);
  }
  static constexpr int kIndexInFileMessages = 1;
  friend void swap(Person_SomeNumber& a, Person_SomeNumber& b) { a.Swap(&b); }
  inline void Swap(Person_SomeNumber* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(Person_SomeNumber* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  Person_SomeNumber* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::Message::DefaultConstruct<Person_SomeNumber>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const Person_SomeNumber& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const Person_SomeNumber& from) { Person_SomeNumber::MergeImpl(*this, from); }
  ...
  void InternalSwap(Person_SomeNumber* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "tutorial.Person.SomeNumber"; }

 protected:
  explicit Person_SomeNumber(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  Person_SomeNumber(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Person_SomeNumber& from);
  Person_SomeNumber(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, Person_SomeNumber&& from) noexcept
      : Person_SomeNumber(arena) {
    *this = ::std::move(from);
  }
 ...
 private:
  ...
  struct Impl_ {
    ...
    inline explicit Impl_(
        ...
        const Person_SomeNumber& from_msg);
...
/* @@protoc_insertion_point(class_definition:tutorial.Person) */ {
 ...
 public:
  ...
  using SomeNumber = Person_SomeNumber;
  ...
  int somenumbers_size() const;
  private:
  int _internal_somenumbers_size() const;

  public:
  void clear_somenumbers() ;
  ::tutorial::Person_SomeNumber* PROTOBUF_NONNULL mutable_somenumbers(int index);
  ::google::protobuf::RepeatedPtrField<::tutorial::Person_SomeNumber>* PROTOBUF_NONNULL mutable_somenumbers();

  private:
  const ::google::protobuf::RepeatedPtrField<::tutorial::Person_SomeNumber>& _internal_somenumbers() const;
  ::google::protobuf::RepeatedPtrField<::tutorial::Person_SomeNumber>* PROTOBUF_NONNULL _internal_mutable_somenumbers();
  public:
  const ::tutorial::Person_SomeNumber& somenumbers(int index) const;
  ::tutorial::Person_SomeNumber* PROTOBUF_NONNULL add_somenumbers();
  const ::google::protobuf::RepeatedPtrField<::tutorial::Person_SomeNumber>& somenumbers() const;
  // string name = 1;
  void clear_name() ;
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::tutorial::Person_SomeNumber > somenumbers_;
...
// double num = 1;
inline void Person_SomeNumber::clear_num() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.num_ = 0;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline double Person_SomeNumber::num() const {
  // @@protoc_insertion_point(field_get:tutorial.Person.SomeNumber.num)
  return _internal_num();
}
inline void Person_SomeNumber::set_num(double value) {
  _internal_set_num(value);
  _impl_._has_bits_[0] |= 0x00000001u;
  // @@protoc_insertion_point(field_set:tutorial.Person.SomeNumber.num)
}
inline double Person_SomeNumber::_internal_num() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.num_;
}
inline void Person_SomeNumber::_internal_set_num(double value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.num_ = value;
}
...
// repeated .tutorial.Person.SomeNumber someNumbers = 6;
inline int Person::_internal_somenumbers_size() const {
  return _internal_somenumbers().size();
}
inline int Person::somenumbers_size() const {
  return _internal_somenumbers_size();
}
inline void Person::clear_somenumbers() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.somenumbers_.Clear();
}
inline ::tutorial::Person_SomeNumber* PROTOBUF_NONNULL Person::mutable_somenumbers(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:tutorial.Person.someNumbers)
  return _internal_mutable_somenumbers()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::tutorial::Person_SomeNumber>* PROTOBUF_NONNULL Person::mutable_somenumbers()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:tutorial.Person.someNumbers)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_somenumbers();
}
inline const ::tutorial::Person_SomeNumber& Person::somenumbers(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:tutorial.Person.someNumbers)
  return _internal_somenumbers().Get(index);
}
inline ::tutorial::Person_SomeNumber* PROTOBUF_NONNULL Person::add_somenumbers()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::tutorial::Person_SomeNumber* _add = _internal_mutable_somenumbers()->Add();
  // @@protoc_insertion_point(field_add:tutorial.Person.someNumbers)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::tutorial::Person_SomeNumber>& Person::somenumbers() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:tutorial.Person.someNumbers)
  return _internal_somenumbers();
}
inline const ::google::protobuf::RepeatedPtrField<::tutorial::Person_SomeNumber>&
Person::_internal_somenumbers() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.somenumbers_;
}
inline ::google::protobuf::RepeatedPtrField<::tutorial::Person_SomeNumber>* PROTOBUF_NONNULL
Person::_internal_mutable_somenumbers() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.somenumbers_;
}
