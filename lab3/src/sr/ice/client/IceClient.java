...
public class IceClient {
	public static void main(String[] args) {
		...
		try {
			...
			ObjectPrx base1 = communicator.stringToProxy("calc/calc11:tcp -h 192.168.145.123 -p 10000 -z : udp -h 192.168.145.123 -p 10000 -z"); //opcja -z włącza możliwość kompresji wiadomości
